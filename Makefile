...
#$(EXCHANGE_DIR)receive_cl.cpp
SRCS = main.cpp $(EXCHANGE_DIR)receive_function.cpp $(EXCHANGE_DIR)receive_header.cpp $(EXCHANGE_DIR)receive_tf.cpp \
				$(EXCHANGE_DIR)exchange_management.cpp $(EXCHANGE_DIR)send_management.cpp $(EXCHANGE_DIR)receive_management.cpp $(EXCHANGE_DIR)receive_function.cpp\
