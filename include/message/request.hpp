...
class request : public message
{
	...
	private : //PRIVATE function which may be public for test
	...
	public : //getter.cpp, this function are used to have access private variable
		...
		std::string		get() const; //to have complete request
