...
curl -i -X GET 127.0.0.1:80/gif/
curl -i -X GET 127.0.0.1:80/html/
curl -i -X GET 127.0.0.1:80/jpeg/
curl -i -X GET 127.0.0.1:80/png/
curl -i -X GET 127.0.0.1:80/private/
curl -i -X GET 127.0.0.1:80/secret/
curl -i -X GET 127.0.0.1:80/spoiler/
curl -i -X GET 127.0.0.1:80/error/
curl -i -X UNKNOW_METHOD 127.0.0.1:80/html/3.html
